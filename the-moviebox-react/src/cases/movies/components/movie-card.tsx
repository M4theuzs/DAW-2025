...
export function MovieCard({ movie }: MovieCardProps) {
  ...
  return (
    <div
      className="bg-[#222] rounded-lg shadow-md overflow-hidden cursor-pointer hover:shadow-xl hover:-translate-y-1 transition"
      onClick={handleSelect}
    >
      <img className="w-full h-[300px] object-cover" src={movie.image} alt={movie.title} />
